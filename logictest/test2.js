...
/*------ PSUEDOCODE ------
 ...
 STORE output AS A EMPTY OBJECT
 LOOP arr  
     IF output WITH KEYS arr[i] IS UNDEFINED
         SET output KEYS WITH arr[i] AS A NUMBER WITH VALUE 0
     END IF
     ASSIGN output arr[i] WITH PLUS EQUAL 1  
END OF LOOP
DISPLAY output
